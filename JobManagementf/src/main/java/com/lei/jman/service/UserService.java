...
import com.lei.jman.config.MessageStrings;
...
import com.lei.jman.dto.UserCreateDto;
import com.lei.jman.enums.ResponseStatus;
...
import com.lei.jman.utils.Helper;

import static com.lei.jman.config.MessageStrings.USER_CREATED;
@Service
public class UserService {
    ...
    public ResponseDto signUp(SignUpDto signupDto)  throws CustomException {
        ...
        User user = new User(signupDto.getFirstName(), signupDto.getLastName(), signupDto.getLinkedinProfile(), signupDto.getEmail(), Role.user, encryptedPassword );
    ...
    public ResponseDto createUser(String token, UserCreateDto userCreateDto) throws CustomException, AuthenticationFailException {
        ...
        User user = new User(userCreateDto.getFirstName(), userCreateDto.getLastName(), userCreateDto.getLinkedinProfile(), userCreateDto.getEmail(), userCreateDto.getRole(), encryptedPassword );
        User createdUser;
        try {
            createdUser = userRepository.save(user);
            final AuthenticationToken authenticationToken = new AuthenticationToken(createdUser);
